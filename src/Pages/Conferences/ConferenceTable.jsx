...
const ConferenceTable = () => {
  ...
  // Function to filter conferences and sort them in descending order based on date
  const filteredConferences = conferences
    ...
    .sort((a, b) => {
      // Sort conferences in descending order based on conference start date
      return new Date(b.conferencestartdate) - new Date(a.conferencestartdate);
    });

  // Calculate the total number of pages after sorting
